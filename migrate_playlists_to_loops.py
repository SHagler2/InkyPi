...
Run this script once before deploying the new InkyPi version.
"""
...
def main():
    ...
    print("=" * 60)
    print("InkyPi Playlist → Loop Migration")
    print("=" * 60)
    ...
    try:
        ...
        print("2. Deploy the updated InkyPi code")
        print("3. Restart the inkypi service")
